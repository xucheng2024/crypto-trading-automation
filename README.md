...
- **Universe:** every normally trading OKX USDT spot pair, discovered at startup and refreshed each UTC+8 day, excluding tokenized stocks (`instCategory` 3) and pairs listed less than four days ago (`OKX_INSTRUMENTS` no longer drives trading).
