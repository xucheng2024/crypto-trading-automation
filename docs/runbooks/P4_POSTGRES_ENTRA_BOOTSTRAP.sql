...
GRANT CONNECT ON DATABASE "<DATABASE>" TO "<MIGRATION_APP_NAME>", "<ENGINE_MI_NAME>", "<MAINTENANCE_MI_NAME>", "<POSITIONS_READ_MI_NAME>";
COMMIT;
...
GRANT USAGE ON SCHEMA public TO "<ENGINE_MI_NAME>", "<MAINTENANCE_MI_NAME>", "<POSITIONS_READ_MI_NAME>";
